...
| `static/brand/` | main | **Brand assets.** The mark (a wide C holding a dot: green arc, gold dot), wordmark lockups (Figtree 600 outlined, no font needed), `favicon.svg`, `app-icon.svg` + 1024 px PNG. Served at `/brand/…`. |
